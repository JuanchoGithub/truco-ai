...
export const tutorialScenarios: TutorialStep[] = [
    {
        ...
        tutorMessage: "Cada carta tiene un valor. El 'Ancho de Espadas' es la más fuerte. Aquí tienes un 'Siete de Oros', una carta muy poderosa.",
    ...
    },
    {
        ...
        tutorMessage: "Cuando tienes dos cartas del mismo palo, puedes cantar 'Envido'. Se suman sus valores y se le agregan 20. Las figuras (10, 11, 12) valen 0. Fíjate, el 5 de Oros vale 5 y el Caballo de Oros vale 0, ¡así que tienes 25 de envido! ¡Cántalo!",
    ...
    },
    {
        ...
        tutorMessage: "¡Wow, qué mano! Tienes el 'Ancho de Espadas' y el 'Siete de Espadas', dos de las cartas más poderosas. Es un momento perfecto para cantar 'Truco' desde el inicio y apostar más fuerte.",
    ...
    {
        title: "¡A Jugar!",
        tutorMessage: "¡Eso es lo básico! Has aprendido sobre el valor de las cartas, el Envido y el Truco. Ahora estás listo para desafiar a la IA. ¡Buena suerte!",
        playerHand: [],
        aiHand: [],
    }
];