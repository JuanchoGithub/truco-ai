...
const AiBlurb: React.FC<AiBlurbProps> = ({ text, isVisible }) => {
  return (
    <div
      className={`absolute top-[140px] lg:top-[160px] left-1/2 -translate-x-1/2 w-80 lg:w-96 p-4 bg-black/80 border-2 border-cyan-400 rounded-lg shadow-lg shadow-cyan-500/30 transition-all duration-500 ease-in-out font-vt323 text-cyan-200 text-lg lg:text-xl text-center z-30 ${
